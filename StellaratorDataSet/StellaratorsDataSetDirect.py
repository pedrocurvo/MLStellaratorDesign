...
class StellaratorDataSetDirect(Dataset):
    def __init__(self,
                 npy_file,
                 transform=None,
                 normalization=None,
                 sample_size: int = None,
                 features_names: list[str] = ['rc1', 'rc2', 'rc3', 'zs1', 'zs2', 'zs3', 'nfp', 'etabar', 'B2c', 'p2'],
                 labels_names: list[str] = ['axis_length', 'iota', 'max_elongation', 'min_L_grad_B', 'min_R0', 
        ...
        self.separation_idx = len(features_names)
        ...
        self.data_dict = {name: idx for idx, name in enumerate(features_names + labels_names)}
    ...
    def calculate_data_counts(self, AXIS_LENGTH, IOTA_MIN, MAX_ELONGATION, MIN_MIN_L_GRAD_B, MIN_MIN_R0, MIN_R_SINGULARITY, MIN_L_GRAD_GRAD_B, MAX_B20_VARIATION, MIN_BETA, MIN_DMERC_TIMES_R2, return_object=False):
        ...
        if return_object:
            ...
            return StellaratorDataSetDirect(data,
